...
const authRoutes = require('./_core/routes/authRoutes'); // Rutas para entrar y registrarse
const apiRoutes = require('./_core/routes/apiRoutes'); // Rutas para dinero y perfil
const adminRoutes = require('./_core/routes/adminRoutes'); // Rutas solo para el jefe (admin)
const errorHandler = require('./_core/middlewares/errorHandler'); // El que atrapa errores si algo falla
